...
def get_args():
    ...
    parser.add_argument("--exp", type=str, default="PDA")
    ...
    parser.add_argument("--tgt_classes", type=int, default=25, help="Number of target classes")
...
class Trainer:
    def __init__(self, args, device):
        ...
        # Dataloader
        self.target_loader = data_helper.get_PDA_adapt_dataloader(args)
        ...
        wandb.init(
            ...
            tags=[args.dataset, args.source, args.target, "PDA"],
            config=vars(args)
        )
