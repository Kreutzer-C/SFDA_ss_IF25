"""
SFDA Test:
Test the target model performance after SFDA adaptation
"""
...
def GSFDA_test():
    ...
    for domain in source_domains:
        args.source = domain
        if args.dataset == "VisDA" and args.source == "real":
            continue
        ...
        for target in target_domains:
            ...
            logging.info(f">>> Test {args.source} --> {args.target} adapted model")
